...
If you also want to see the source code for this website (and perhaps even edit it), you can find it [here](https://github.com/candemircan/docs_implied_motion)
